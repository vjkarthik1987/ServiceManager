...
const fileAssetSchema = new mongoose.Schema(
  {
    ...
    storageProvider: { type: String, enum: ['local', 's3', 'sharepoint', 'cloudinary'], default: 'local' },
    storagePath: { type: String, required: true, trim: true },
    storageExternalId: { type: String, default: '', trim: true, index: true },
    storageWebUrl: { type: String, default: '', trim: true },
    storageSecureUrl: { type: String, default: '', trim: true },
    checksumSha256: { type: String, default: '', trim: true, index: true },
    visibility: { type: String, enum: ['EXTERNAL', 'INTERNAL'], default: 'EXTERNAL', index: true },
    isInternalOnly: { type: Boolean, default: false, index: true },
    malwareScanStatus: { type: String, enum: ['NOT_SCANNED', 'PENDING', 'PASSED', 'FAILED'], default: 'NOT_SCANNED', index: true },
