...
const entitySchema = new mongoose.Schema(
  {
    ...
    acronym: { type: String, required: true, trim: true, uppercase: true, match: /^[A-Z0-9]{6}$/ },
    ...
    metadata: {
      ...
      moduleIds: { type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'ModuleDefinition' }], default: [] },
