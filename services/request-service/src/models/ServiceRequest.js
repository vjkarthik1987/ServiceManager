...
const requestStatusSchema = new mongoose.Schema(
  {
    ...
    jiraStatusId: { type: String, trim: true, maxlength: 40, default: '' },
    jiraStatusCategory: { type: String, trim: true, maxlength: 40, default: '' },
    approvalConfiguration: { type: mongoose.Schema.Types.Mixed, default: null },
    sourceProperties: { type: mongoose.Schema.Types.Mixed, default: () => ({}) },
    jiraDescription: { type: String, trim: true, maxlength: 800, default: '' },
    taskTemplates: {
      type: [
        {
...
const workflowTransitionSchema = new mongoose.Schema(
  {
    ...
    jiraCustomerEnabled: { type: Boolean },
    ...
    jiraTransitionType: { type: String, trim: true, maxlength: 30, default: '' },
    transitionScreenId: { type: String, trim: true, maxlength: 40, default: '' },
    requiredFields: { type: [mongoose.Schema.Types.Mixed], default: [] },
    screenFields: { type: [mongoose.Schema.Types.Mixed], default: [] },
    jiraRules: { type: mongoose.Schema.Types.Mixed, default: () => ({}) },
...
const activeSupportStageSchema = new mongoose.Schema(
  {
    ...
    previousStatusId: { type: String, trim: true, maxlength: 40, default: '' },
    previousStatusName: { type: String, trim: true, maxlength: 120, default: '' }
  },
  { _id: false }
);
