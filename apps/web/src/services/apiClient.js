...
export async function createLevel3IssueType(organizationId, data) {
  return request(orgUrl(`/api/organizations/${organizationId}/issue-types/level3`), {
    method: 'POST',
    body: JSON.stringify(data)
  });
}

export async function updateTaxonomyBehavior(organizationId, issueTypeId, data) {
  return request(orgUrl(`/api/organizations/${organizationId}/issue-types/${issueTypeId}/behavior`), {
    method: 'POST',
    body: JSON.stringify(data)
  });
}
...
export async function addIssueTypeCustomField(organizationId, issueTypeId, data) {
  return request(orgUrl(`/api/organizations/${organizationId}/issue-types/${issueTypeId}/custom-fields`), {
    method: 'POST',
    body: JSON.stringify(data)
  });
}
...
export async function updateIssueTypeCustomField(organizationId, issueTypeId, fieldKey, data) {
  return request(orgUrl(`/api/organizations/${organizationId}/issue-types/${issueTypeId}/custom-fields/${encodeURIComponent(fieldKey)}`), {
    method: 'POST',
    body: JSON.stringify(data)
  });
}
...
export async function clientRequestAction(organizationId, requestId, data) {
  return request(requestUrl(`/api/organizations/${organizationId}/requests/${requestId}/client-action`), {
    method: 'POST',
    body: JSON.stringify(data)
  });
}

export async function claimSlaNotifications(organizationId) {
  return request(requestUrl(`/api/organizations/${organizationId}/requests/sla-notification-candidates`), {
    method: 'POST',
    body: JSON.stringify({})
  });
}
...
export async function getV23SaasFormDefinition(organizationId, level1TypeId, level2TypeId, level3TypeId = '') {
  ...
  return request(requestUrl(`/api/organizations/${organizationId}/v23/form-definition?${params.toString()}`));
}
